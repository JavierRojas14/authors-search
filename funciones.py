...
def obtener_resumen_de_articulos(string_articulos):
    ...
    resumen_articulos = resumen_articulos.reset_index(names="id_articulo")
...
def resumir_cantidad_de_autores(resumen_articulos):
    # Obtiene el numero de articulos totales
    n_articulos = max(resumen_articulos["id_articulo"]) + 1
